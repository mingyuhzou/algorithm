...
观察到n的范围是1e5，因此是不可能构建矩阵的，这里利用gcd(a,b,c)=gcd(a,|b-a|,|c-d|)的性质。
...
<img src="./assets/image-20250313110415121.png" alt="image-20250313110415121" style="zoom:80%;" />

<img src="./assets/image-20250313110357394.png" alt="image-20250313110357394" style="zoom: 67%;" />

考虑每一次加k逆序对如何变化，先对原数组每个元素模m，当k=1时，只有大小为m-1的元素贡献的逆序对会变化，假设大小为m-1的元素的位置为[a1,a2,a3]，对于a2它前面的元素除了a1都会与+k后的a2形成逆序对，它后面的元素除了a3都会与a2形成逆序对(因为模m后最大值为m-1)，当+k后这些逆序对都会消失。处理完1后，k=2会在1的基础上继续，即此时m-2为最大值。

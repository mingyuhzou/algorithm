...
<img src="./assets/image-20250503091447805.png" alt="image-20250503091447805" style="zoom:50%;" />
...
离线询问，首先按照左端点的值排序，枚举每一个询问的线段c d，将给定的线段数组中左端点小于c的线段(a,b)的右端点b记录到树状数组中，统计得到满足第一种情况的个数。随后再按照右端点的值排序，得到第二种情况的个数。

...
在拓扑序上DP类似于**刷表法**，在计算拓扑序的过程中同时进行状态转移。

## [并行课程 III](https://leetcode.cn/problems/parallel-courses-iii/)

<img src="assets/image-20240719090834745-1730904623054-2.png" alt="image-20240719090834745" style="zoom: 80%;" />

<img src="assets/image-20240719090842653-1730904623054-3.png" alt="image-20240719090842653" style="zoom: 67%;" />
...
<img src="./assets/image-20240126124149923-1733840243523-427-1734403865240-3.png" alt="image-20240126124149923" style="zoom:67%;" />
...
## [Development(有修改floyd)](https://atcoder.jp/contests/abc416/tasks/abc416_e)

![image-20250809181455699](./assets/image-20250809181455699.png)

<img src="./assets/image-20250809181531948.png" alt="image-20250809181531948" style="zoom:67%;" />
...
这里的子节点指的是**dfs搜索过程中的子节点**。左图中有两个子节点，右图中只有一个子节点，记录点的集合不弹出。

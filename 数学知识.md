...
![image-20240515111152549](E:/Git_/algorithm/img/image-20240515111152549.png)****
...
![image-20240130150632171](E:/Git_/algorithm/img/image-20240130150632171.png)
...
![image-20240130160309064](E:/Git_/algorithm/img/image-20240130160309064.png)



一个数的约数个数通过公式可得是：是他的质因数中(指数+1)的累积

![image-20240130160418078](E:/Git_/algorithm/img/image-20240130160418078.png)
...
![image-20240130161336032](E:/Git_/algorithm/img/image-20240130161336032.png)

![image-20240130161314099](E:/Git_/algorithm/img/image-20240130161314099.png)
...
![image-20240130165644747](E:/Git_/algorithm/img/image-20240130165644747.png)
...
![image-20240130173430192](E:/Git_/algorithm/img/image-20240130173430192.png)
...
<img src="E:/Git_/algorithm/img/image-20240131162152654.png" alt="image-20240131162152654" style="zoom:50%;" />

在调用欧几里得算法的过程中，反转了a和b，因此x和y传入的时候也要反转。根据推到可以得到外层的系数和下一层循环的系数右一定的联系。

<img src="E:/Git_/algorithm/img/image-20240131162759346.png" alt="image-20240131162759346" style="zoom:50%;" />
...
<img src="E:/Git_/algorithm/img/image-20240411174422857.png" alt="image-20240411174422857" style="zoom:50%;" />
...
<img src="E:/Git_/algorithm/img/image-20240131170011057.png" alt="image-20240131170011057" style="zoom:50%;" />
...
![image-20240202214828889](E:/Git_/algorithm/img/image-20240202214828889.png)
...
![image-20240411174720441](E:/Git_/algorithm/img/image-20240411174720441.png)



其中a和m是已知的，注意m是互质(最大公约数为1)的要求

不论证明过程，最后最小的x等于![image-20240411174901213](E:/Git_/algorithm/img/image-20240411174901213.png)
...
![image-20240202210634657](E:/Git_/algorithm/img/image-20240202210634657.png)
...
![image-20240202214931942](E:/Git_/algorithm/img/image-20240202214931942.png)
...
![image-20240202221335973](E:/Git_/algorithm/img/image-20240202221335973.png)
...
<img src="E:/Git_/algorithm/img/image-20240224110659338.png" alt="image-20240224110659338" style="zoom:50%;" />

<img src="E:/Git_/algorithm/img/image-20240224110732942.png" alt="image-20240224110732942" style="zoom:50%;" />
...
![image-20240203211447969](E:/Git_/algorithm/img/image-20240203211447969.png)



### 生成字符串

![image-20240203210337771](E:/Git_/algorithm/img/image-20240203210337771.png)



把文图抽象为图像，1相当于向右上走，0相当于向右下走，为了1的个数要大于0需要在组合的过程中不要经过y=-1这条线否则就是0的个数大于1的个数

![image-20240203210535268](E:/Git_/algorithm/img/image-20240203210535268.png)
...
![image-20240203212220222](E:/Git_/algorithm/img/image-20240203212220222.png)
...
![image-20240203214312192](E:/Git_/algorithm/img/image-20240203214312192.png)

这里取模数是100不能使用飞马小定理求解逆元，对卡特兰数使用定义计算：

![image-20240203214354855](E:/Git_/algorithm/img/image-20240203214354855.png)
...
![image-20240407171632359](E:/Git_/algorithm/img/image-20240407171632359.png)



对于较大的冥次比如说n达到10**9，保证不会溢出的情况下使用迭代求解会超时。快速冥的做法是把冥次拆分为二进制数（比如6写为110，$2^2+2^1$），然后只操作这些位

<img src="E:/Git_/algorithm/img/image-20240407172210473.png" alt="image-20240407172210473" style="zoom:50%;" />
...
![image-20240407175031421](E:/Git_/algorithm/img/image-20240407175031421.png)

对于给定的数据范围迭代和递归都无法满足，观察递推式发现：

<img src="E:/Git_/algorithm/img/image-20240407175156225.png" alt="image-20240407175156225" style="zoom:67%;" />
...
![image-20240205223921806](E:/Git_/algorithm/img/image-20240205223921806.png)



往外推广的结果是1-2+3-4+5-6+....+(-1)^(n-1)*n，奇数个集合是加偶数个集合是减。

![image-20240206205659281](E:/Git_/algorithm/img/image-20240206205659281.png)

可以看作是从n个数中选取任意个，一共有2^n-1个状态（注意不会选0个，等式左边会补上 $$C^0_n$$）

![image-20240206205857998](E:/Git_/algorithm/img/image-20240206205857998.png)
...
![image-20240214160814559](E:/Git_/algorithm/img/image-20240214160814559.png)
